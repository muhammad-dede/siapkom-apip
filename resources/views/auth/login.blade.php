        ...
        <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
                <a href="{{ route('home') }}" class="app-brand-link gap-2">
                    ...
                    <h4 class="demo text-body fw-bolder pt-4">{{ config('app.name') }}</h4>
                </a>
            </div>
            <!-- /Logo -->
            <h5 class="mb-2 text-center">{{ config('app.name_2') }}</h5>
            <hr>
            <form id="formAuthentication" class="mb-3" action="{{ route('authenticate') }}" method="POST">
                @csrf
                <div class="mb-3">
                    <label for="username" class="form-label">NIP / Nama Pengguna</label>
