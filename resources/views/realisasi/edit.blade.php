...
@section('title', 'Edit Realisasi Diklat')

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-3">Edit Realisasi Diklat</h4>
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header">
                        <h4>Formulir Edit Realisasi Diklat</h4>
                        <small>Silahkan lengkapi data-data berikut ini dengan benar dan lengkap!</small>
                    </div>
                    <div class="card-body">
                        <form id="form-edit-realisasi" action="{{ route('realisasi.update', $peserta->id_peserta) }}"
        ...
        $(document).ready(function() {
            ...
            function data_diklat() {
                ...
                if (id_jenis_diklat == "") {
                    ...
                    $.ajax({
                        url: "{{ route('realisasi.edit', $peserta->id_peserta) }}",
                        method: "GET",
                        data: {
            ...
            $("#form-edit-realisasi").on("submit", function(event) {
